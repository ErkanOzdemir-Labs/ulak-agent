...
def _state_dir() -> Path:
    ...
    # Default: $ULAK_HOME/watcher-state/, falling back to ~/.ulak/watcher-state/.
    ulak_home = os.environ.get("ULAK_HOME") or str(Path.home() / ".ulak")
    return Path(ulak_home) / "watcher-state"
