...
Data file: $ULAK_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ULAK_HOME = Path(os.environ.get("ULAK_HOME", Path.home() / ".ulak"))
DATA_DIR = _ULAK_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
