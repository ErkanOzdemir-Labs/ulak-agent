...
_SESSION_CWD: ContextVar = ContextVar("ULAK_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the Ulak source tree, a
    legitimate workspace when developing Ulak; fallback-directory policy lives in the caller."""
