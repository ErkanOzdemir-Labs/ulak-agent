...
def _moa_privacy_mode(moa_raw: Any) -> str:
    ...
    from ulak_cli.moa_config import coerce_privacy_filter
...
def aggregate_moa_context(
    *, user_prompt: str, api_messages: list[dict[str, Any]], reference_models: list[dict[str, Any]],
    ...
    synth_prompt = (
        ...
        "Ulak agent. Focus on next steps, tool-use strategy, risks, and any "
    ...
    return (
        ...
        "normal Ulak agent loop. You may call tools, continue reasoning, or "
        "finish normally.]\n"
