...
re-registration logging, and the snapshot/restore pair :mod:`ulak_cli.plugins`
...
class ProviderRegistry(Generic[P]):
    ...
    def merged(self, scope: Optional[str] = None) -> Dict[str, P]:
        ...
        with self._lock:
            ...
            merged.update(self._scoped_providers.get(scope or ulak_home_key(), {}))
        return merged
    ...
    def get_provider(self, name: str, *, scope: Optional[str] = None) -> Optional[P]:
        ...
        with self._lock:
            return (
                self._scoped_providers.get(scope or ulak_home_key(), {}).get(key)
    ...
    def registry_generation(self, *, scope: Optional[str] = None) -> tuple:
        ...
        active_scope = scope or ulak_home_key()
        with self._lock:
