...
def _is_deepseek_anthropic_endpoint(base_url: str | None) -> bool:
    ...
    keep-unsigned policy used for Kimi's ``/coding`` endpoint. See ulak-agent#16748.
    """
...
def _is_nous_portal_endpoint(base_url: str | None) -> bool:
    ...
    thinking-signature replay). Trusted hosts only: prod ``inference-api.github.com/ErkanOzdemir-Labs`` or the
    ...
    if base_url_host_matches(base_url or "", "inference-api.github.com/ErkanOzdemir-Labs"):
        return True
    try:
