...
def _warn_native_compaction_suppressed_by_checkpoint_gate() -> None:
    ...
    if not _checkpoint_suppression_logged:
        ...
        logger.warning(
            ...
            "checkpoint-aware Ulak compressor stays authoritative."
        )
...
def prune_pre_checkpoint_items(
    ...
    A summary is never byte/character-sliced: Ulak summaries carry structural framing (handoff prefix, end
