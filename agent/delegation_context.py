...
A Ulak process may itself be a Kanban dispatcher worker with ULAK_KANBAN_* in
...
_DELEGATED_CHILD_CONTEXT: ContextVar[bool] = ContextVar("ulak_delegated_child_context", default=False)
...
_NON_DISPATCHER_OWNED_CONTEXT: ContextVar[bool] = ContextVar("ulak_non_dispatcher_owned_context", default=False)

DELEGATED_CHILD_ENV_MARKER = "ULAK_DELEGATED_CHILD_CONTEXT"

KANBAN_ENV_KEYS: tuple[str, ...] = (
    "ULAK_KANBAN_TASK", "ULAK_KANBAN_RUN_ID", "ULAK_KANBAN_WORKSPACE", "ULAK_KANBAN_WORKSPACES_ROOT",
    "ULAK_KANBAN_CLAIM_LOCK", "ULAK_KANBAN_BOARD", "ULAK_KANBAN_DB",
)
...
def is_dispatcher_owned_worker_context() -> bool:
    """The single predicate every ``ULAK_KANBAN_*`` identity gate should use."""
