...
def run_tool_round(
    ...
    Ulak; a failed canonical append ends the turn rather than running tools from
    process-only state."""
    ...
    # block if a destructive tool restarts Ulak.
    try:
    ...
    # the gateway inactivity timeout (ULAK_AGENT_TIMEOUT).
    ...
    # follow-up API call can exceed the gateway inactivity timeout (ULAK_AGENT_TIMEOUT, default 1800s) and
