...
_REPAIR_HINT = (
    "Repair: run `ulak doctor --fix` (auto-reinstalls certifi), or "
...
def verify_ca_bundle() -> None:
    ...
    is missing/corrupt."""
    if is_truthy_value(os.getenv("ULAK_SKIP_SSL_GUARD", "")):
        logger.debug("SSL CA bundle guard skipped via ULAK_SKIP_SSL_GUARD")
        return
