...
def _fire_pre_api_request_hook(
    ...
    try:
        from ulak_cli.lifecycle import has_hook, invoke_hook as _invoke_hook
...
def build_api_request(
    ...
    try:
        from ulak_cli.middleware import apply_llm_request_middleware
    ...
    if env_var_enabled("ULAK_DUMP_REQUESTS"):
