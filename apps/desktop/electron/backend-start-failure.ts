 ...
 * startUlak() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startUlak() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startUlak`, re-emits
