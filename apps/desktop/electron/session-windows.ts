...
// by main.ts (`setBackgroundThrottling` driven by the merged `ulak:active-work`
...
// (the "Ulak idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Ulak" wake word has NO preceding click,
