 ...
 *
 * A public install can end up with `origin=git@github.com:ErkanOzdemir-Labs/ulak-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/ErkanOzdemir-Labs/ulak-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/erkanozdemir-labs/ulak-agent'
