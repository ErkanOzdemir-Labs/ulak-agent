...
function expectRequestHeaders(
  ...
  applyRemoteRequestHeaders({ url, requestHeaders: { Origin: 'app://ulak' } }, callback, store.headersFor)

  expect(callback).toHaveBeenCalledOnce()
  expect(callback).toHaveBeenCalledWith(expected ? { requestHeaders: { Origin: 'app://ulak', ...expected } } : {})
}
