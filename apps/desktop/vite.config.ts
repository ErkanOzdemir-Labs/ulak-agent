...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\ulak\ulak-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@ulak/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@ulak/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@ulak/shared': path.resolve(__dirname, '../shared/src'),
