...
cd apps/desktop
XCURSOR_SIZE=24 ULAK_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/ulak-typing
# → /tmp/ulak-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/ulak-typing.before.heapsnapshot
# → /tmp/ulak-typing.after.heapsnapshot
```
