...
// (#73044). Exercises the REAL ulak + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/ulak')
...
const conn = (over: Partial<UlakConnection> = {}): UlakConnection =>
  ({
    authMode: 'oauth',
