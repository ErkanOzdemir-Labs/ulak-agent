...
export const en: Translations = {
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Ulak defaults?',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Ulak Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Ulak is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Ulak…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Ulak',
