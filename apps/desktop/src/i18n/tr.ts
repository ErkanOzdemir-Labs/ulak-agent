...
export const tr: Translations = {
  sessionImport: {
    ...
    subtitle: 'Bring a conversation into Ulak and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Ulak.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Ulak. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Ulak',
    continue: 'Continue in Ulak',
  ...
  boot: {
    ready: 'Ulak Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Ulak settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Ulak backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingUlakDesktop: 'Starting Ulak Desktop…'
    },
    errors: {
      backgroundExited: 'Ulak background process exited.',
      backgroundExitedDuringStartup: 'Ulak background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Ulak backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateUlak: 'Update Ulak',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Ulak Desktop.',
    ...
    native: {
      ...
      inputBody: 'Ulak is waiting for your response.',
      turnDoneTitle: 'Ulak finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `ulak debug share --nous` from a terminal, or `ulak debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Ulak backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Ulak backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Ulak is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Ulak asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Ulak was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Ulak was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Ulak follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Ulak can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Ulak when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Ulak walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Ulak is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Ulak, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The Ulak runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Ulak only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Ulak',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Ulak checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Ulak configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Ulak.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Ulak gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Ulak Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Ulak Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Ulak runtime managed by this app.',
      kindRemoteDesc: 'A Ulak gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Ulak Cloud account.',
      kindSshDesc: 'A Ulak install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Ulak manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Ulak Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      remoteDesc: 'Connect this desktop shell to a remote Ulak backend.',
      ...
      cloudDesc: 'Sign in once to Ulak Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Ulak Cloud',
      cloudSignIn: 'Sign in to Ulak Cloud',
      cloudSignedIn: 'Signed in to Ulak Cloud',
      cloudNeedsSignIn: 'Sign in to Ulak Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Ulak Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Ulak Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Ulak Cloud',
      cloudSignedOutMessage: 'Cleared the Ulak Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /ulak.',
      ...
      restartingMessage: 'Ulak Desktop will reconnect using the saved settings — the shell stays open.',
      ...
      sshDesc:
        'Ulak is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshUlakPathTitle: 'Ulak path (optional)',
      sshUlakPathDesc: 'Full path to the remote ulak binary. Blank = auto-detect.',
      sshUlakPathPlaceholder: 'auto-detect',
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Ulak runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Ulak is not installed on the remote host. Install it there (curl -fsSL https://ulak-agent.github.com/ErkanOzdemir-Labs/install.sh | sh) or set the Ulak path.',
      sshErrPlatform:
        'Unsupported remote platform. Ulak Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Ulak on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Ulak. Review the exact configuration below — it comes from the link, not from Ulak.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Ulak runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Ulak at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Ulak browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via ulak curator restore.',
  ...
  starmap: {
    ...
    emptyDesc: 'As Ulak builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Ulak to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Ulak to generate pets.',
      backgroundHint: 'You can close this — Ulak will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Ulak desktop' },
    ...
    ulakActiveSessions: (version, count) => `Ulak ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@ulak:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Ulak you point it at, instead of this computer.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Ulak environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Ulak did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Ulak will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Ulak backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Ulak. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Ulak backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Ulak...',
    placeholderReconnecting: 'Reconnecting to Ulak…',
    ...
    attachUrlDesc: 'Ulak will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Ulak…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Ulak…',
    ...
    unsupportedMessage: 'This version of Ulak can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Ulak from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Ulak will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Ulak desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Ulak updater takes over in its own window and reopens Ulak automatically when it’s done. Please don’t reopen Ulak yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Ulak reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Ulak reopens on its own.',
    ...
    mixedBlockerBody:
      'Ulak can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Ulak needs a one-time install',
    ...
    installLocalTitle: 'Install Ulak locally',
    installLocalDesc: 'Download Ulak, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Ulak Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Ulak',
    remoteSetupDesc: 'Enter your gateway URL. Ulak Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Ulak gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/ulak',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Ulak gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Ulak Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Ulak CLI or desktop instance is running. Stop any running Ulak instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Ulak at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Ulak connects automatically',
    ...
    authorizeThere: 'Authorize Ulak there.',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Ulak will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Ulak is restarting...',
      askRestart: 'Ask Ulak to restart the server',
      lookingRestart: taskId => `Ulak is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Ulak is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Ulak to open a page.',
      ...
      restartFailedMessage: 'Ulak could not restart the server.',
      stillWorking:
        'Ulak is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Ulak is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Ulak gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.ulak/config.yaml). Ulak won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Ulak needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Ulak needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Ulak Desktop to use Save Image.',
    restartToSaveImages: 'Restart Ulak Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `ulak gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Ulak loads when the work calls for them.'
      },
      messaging: {
        title: 'Ulak away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Ulak made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Ulak — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
