...
export type Locale = 'en' | 'zh' | 'zh-hant' | 'ja' | 'ar' | 'ru' | 'tr'
...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshUlakPathTitle: string
      sshUlakPathDesc: string
      sshUlakPathPlaceholder: string
  ...
  commandCenter: {
    ...
    ulakActiveSessions: (version: string, count: number) => string
