...
const TAKEOVER_KEY = 'ulak.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Ulak can't clear via the API — the user
 *  sees exactly what runs instead of Ulak silently deleting their creds. */
