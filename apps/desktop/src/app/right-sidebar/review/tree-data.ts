import type { UlakReviewFile } from '@/global'
...
export function buildReviewFlatList(files: UlakReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: UlakReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
