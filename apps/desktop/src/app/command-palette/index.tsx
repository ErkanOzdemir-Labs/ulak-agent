...
import { getUlakConfigRecord, listAllProfileSessions } from '@/ulak'
...
// Ulak session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-ulak',
            keywords: ['update', 'upgrade', 'ulak', 'version', 'system', 'restart'],
            label: cc.updateUlak,
