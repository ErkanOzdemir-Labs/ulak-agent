...
import { deleteLearningNode, type ProfileScope } from '@/ulak'

export const ARCHIVE_SKILL_DESCRIPTION = 'The skill is archived and can be restored with `ulak curator restore`.'
