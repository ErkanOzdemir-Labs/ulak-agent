...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/ulak'
...
// highlight markers (sqlite snippet() delimiters — see ulak_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('ulak:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('ulak:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Ulak to
