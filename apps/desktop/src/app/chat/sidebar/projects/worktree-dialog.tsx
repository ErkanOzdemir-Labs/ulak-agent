...
import type { UlakGitBranch } from '@/global'
...
const branchActionLabel = (branch: UlakGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<UlakGitBranch[]>([])
  ...
  const convert = async (branch: UlakGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
