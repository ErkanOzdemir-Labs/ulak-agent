...
const FOCUS_EVENT = 'ulak:composer-focus'
const INSERT_EVENT = 'ulak:composer-insert'
const ATTACH_IMAGES_EVENT = 'ulak:composer-attach-images'
const INSERT_REFS_EVENT = 'ulak:composer-insert-refs'
const SUBMIT_EVENT = 'ulak:composer-submit'
const VOICE_TOGGLE_EVENT = 'ulak:composer-voice-toggle'
const MODEL_MENU_EVENT = 'ulak:composer-model-menu'
