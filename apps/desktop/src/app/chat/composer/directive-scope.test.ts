...
describe('directive scope is a browse mode, not text to maintain', () => {
  ...
  it('pasting into an open @url: scope consumes it instead of stacking', () => {
    ...
    paste(editor, 'https://github.com/ErkanOzdemir-Labs/ulak-agent/pull/74533')

    expect(composerPlainText(editor)).toBe('refer to @url:`https://github.com/ErkanOzdemir-Labs/ulak-agent/pull/74533`')
