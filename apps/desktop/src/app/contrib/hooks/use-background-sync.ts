...
import { getLatestSessionMessages, type ProfileScope } from '@/ulak'
...
interface BackgroundSyncParams {
  ...
  refreshUlakConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshUlakConfig])
}
