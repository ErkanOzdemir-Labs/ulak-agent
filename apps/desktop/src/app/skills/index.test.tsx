...
vi.mock('@/ulak', async importOriginal => ({
  ...(await importOriginal<typeof UlakApi>()),
...
describe('SkillsView toolset management', { timeout: 60_000 }, () => {
    ...
    await act(async () => {
      window.dispatchEvent(
        new MessageEvent('message', {
          data: { type: 'ulak-skill-pick', name: 'web-research', identifier: 'web-research' },
          origin: 'https://ulak-agent.github.com/ErkanOzdemir-Labs'
        })
      )
    })
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { ulakDesktop?: unknown }).ulakDesktop = { connections, getAgentRoster }
