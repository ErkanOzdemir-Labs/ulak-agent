...
// / Program Files), which buried any files Ulak wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.ulakDesktop` is
    ...
    const settings = window.ulakDesktop?.settings
