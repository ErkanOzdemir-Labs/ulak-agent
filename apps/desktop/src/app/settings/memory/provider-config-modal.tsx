...
import type { MemoryProviderConfig, MemoryProviderField } from '@/types/ulak'
import { saveMemoryProviderConfig } from '@/ulak'
          ...
          {config.docs_url && (
            <a
              ...
              onClick={event => {
                ...
                void window.ulakDesktop?.openExternal?.(config.docs_url)
              }}
              rel="noreferrer"
              target="_blank"
            >
