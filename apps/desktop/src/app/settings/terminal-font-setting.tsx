...
function fontFamilyFromConfig(config: UlakConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useUlakConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<UlakConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setUlakConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="ulak-terminal-font-families"
          ...
          <datalist id="ulak-terminal-font-families">
