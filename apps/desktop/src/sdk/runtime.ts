 ...
 * plugins resolve `@ulak/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __ULAK_PLUGIN_SDK__: sdk,
  __ULAK_REACT__: React,
  __ULAK_REACT_JSX__: jsxRuntime,
  __ULAK_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@ulak/plugin-sdk': shimUrl('__ULAK_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__ULAK_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__ULAK_REACT_JSX__'),
    react: shimUrl('__ULAK_REACT__')
  }
