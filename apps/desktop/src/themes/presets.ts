...
/**
 * Nous — the canonical Ulak desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Ulak's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Ulak desktop identity: GitHub's chrome carrying Nous
