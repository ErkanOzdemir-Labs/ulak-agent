/**
 * Ulak skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$ULAK_HOME/skins/` (or a
 * built-in) resolved by `ulak_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Ulak authors from a prompt lights up all three surfaces from one file.
 *
...
import type { UlakSkin, SkinColors } from '@ulak/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: UlakSkin): DesktopTheme | null {
