...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/ulak-agent')).toBe('~/www/ulak-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/ulak-agent')).toBe('ulak-agent')
    expect(pathLeaf('~/www/ulak-agent')).toBe('ulak-agent')
