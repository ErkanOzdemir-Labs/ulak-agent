...
import type { ModelOptionsResponse, SessionInfo } from '@/types/ulak'
 ...
 *
 * Only the leading status prefix (e.g. "Ulak is thinking...") and the
 ...
 *  resolved comment as JSON (UlakPrComment shape); a malformed payload falls
