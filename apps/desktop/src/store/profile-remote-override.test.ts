...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://ulak.example.com:8443/x')).toBe('ulak.example.com:8443')
    expect(remoteHostLabel('https://ulak.example.com:443')).toBe('ulak.example.com')
    expect(remoteHostLabel('http://ulak.example.com:80')).toBe('ulak.example.com')
  })
