...
const POPOUT_STORAGE_KEY = 'ulak.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'ulak.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'ulak.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'ulak.desktop.composerPopout.position'
