...
// v1 (`ulak.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'ulak.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'ulak.desktop.statusbarHidden'
// v1 (`ulak.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'ulak.desktop.statusbarVisible.v2'
