...
export interface PetInfo {
  ...
  // the Ulak "run" activity state uses the in-place running row).
 ...
 * ULAK_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'ulak.desktop.pet-roam.v1'
