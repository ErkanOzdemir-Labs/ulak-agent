...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('ulak.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('ulak.desktop.unreadFinishedSessions')
