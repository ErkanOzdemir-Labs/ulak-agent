...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@ulak/plugin-sdk'
 ...
 *  (ulak-agent#90102) and are discarded. Without `canonical_session` (older
