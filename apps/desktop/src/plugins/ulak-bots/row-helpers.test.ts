 ...
 *    the primary profile surfaced as @default instead of @ulak;
 ...
 *    kanban/tool workers count too (ulak-agent#90268): a profile grinding
...
describe('previewKind classifies a roster preview', () => {
  ...
  it('surfaces the primary profile as @ulak, never @default (#89484)', () => {
    expect(fromBot("Message from agent 'default': deploy is green")).toBe('ulak')
