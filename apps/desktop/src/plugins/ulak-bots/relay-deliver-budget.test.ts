...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/ulak-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'ulak_cli/config_defaults.py'), 'utf8')
