 ...
 * `<ulak home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'ulak.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'ulak.desktop.disabledPlugins.v1'
