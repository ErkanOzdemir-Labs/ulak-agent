...
describe('preprocessMarkdown', () => {
  ...
  it('does not swallow trailing emphasis asterisks into an autolinked url', () => {
    const input = '**PR opened: https://github.com/ErkanOzdemir-Labs/ulak-agent/pull/12345**'
    ...
    expect(output).toContain('<https://github.com/ErkanOzdemir-Labs/ulak-agent/pull/12345>')
