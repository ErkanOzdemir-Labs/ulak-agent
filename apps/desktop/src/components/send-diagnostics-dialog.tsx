...
const SUPPORT_LINKS = [
  { key: 'github', url: 'https://github.com/ErkanOzdemir-Labs/ulak-agent/issues' },
  { key: 'portal', url: 'https://portal.github.com/ErkanOzdemir-Labs/help' },
  { key: 'discord', url: 'https://discord.gg/ErkanOzdemir-Labs' }
] as const
