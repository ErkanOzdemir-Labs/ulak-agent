...
const STORAGE_KEY = 'ulak.desktop.layoutTree.v2'

writeKey('ulak.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('ulak.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('ulak.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'ulak.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'ulak.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'ulak.desktop.hiddenStripTabs.v1'
...
writeKey('ulak.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__ULAK_LAYOUT_TREE__ = {
    close: closeTreePane,
