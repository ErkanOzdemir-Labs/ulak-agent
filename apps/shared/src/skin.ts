/**
 * Canonical Ulak skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$ULAK_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`ulak_cli/skin_engine.py`),
 ...
 *   • CLI     → `ulak_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
