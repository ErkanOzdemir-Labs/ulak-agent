      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via ULAK_BUNDLED_SKILLS /
            # ULAK_OPTIONAL_SKILLS (see ulak-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + ULAK_BUNDLED_LOCALES
            # / ULAK_OPTIONAL_MCPS, not via the wheel. Excluding them
