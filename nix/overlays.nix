# nix/overlays.nix — Expose pkgs.ulak-agent for external NixOS configs
#
...
# `pkgs.ulak-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    ulak-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
