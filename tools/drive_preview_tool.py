#!/usr/bin/env python3
"""Interact with the in-app browser / preview pane in the Ulak desktop GUI (click, type, scroll).
...
def drive_preview_tool(
    ...
    if callback is None:
        return tool_error("drive_preview is only available in the Ulak desktop app.")
