...
LOCAL_STT_COMMAND_ENV = "ULAK_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "ULAK_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via ulak_cli.models.deepinfra_base_url (shared).
