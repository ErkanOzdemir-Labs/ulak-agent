...
# containing `cat ~/.ulak/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `ulak-agent-dev` skill contains a security postmortem mentioning `cat ~/.ulak/.env`, which tripped
