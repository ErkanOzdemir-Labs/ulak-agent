...
DIALOG_BRIDGE_HOST = "ulak-dialog-bridge.invalid"
...
(() => {
  if (window.__ulakDialogBridgeInstalled) return;
  window.__ulakDialogBridgeInstalled = true;
  const ENDPOINT = "http://ulak-dialog-bridge.invalid/";
