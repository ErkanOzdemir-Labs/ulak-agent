...
Used by ulak_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "ULAK_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"ULAK_HOME": _ulak_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'ULAK_INDEX_TTL': ('tools.skills_hub_search', 'ULAK_INDEX_TTL'),
    'ULAK_INDEX_URL': ('tools.skills_hub_search', 'ULAK_INDEX_URL'),
    'UlakIndexSource': ('tools.skills_hub_official', 'UlakIndexSource'),
