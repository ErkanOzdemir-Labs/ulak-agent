...
def _transcribe_local_command(
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="ulak-local-stt-") as output_dir:
            ...
            # Scrub Ulak secrets from the child env (same policy as _run_command_stt).
            # Scrub Ulak secrets from the child env (sibling path to #56332 / _run_command_stt — this
            ...
            _run_quiet(shlex.split(command), timeout=300, env=ulak_subprocess_env(inherit_credentials=False))
