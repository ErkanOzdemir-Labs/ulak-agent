"""Plugin-owned durable state and namespaced settings helpers (split out of ulak_cli.plugins)."""
...
from ulak_cli.plugins_manifest import _portable_skill_namespace
...
class PluginState:
    ...
    def data_dir(self) -> Path:
        ...
        return get_ulak_home() / "plugin-data" / self._data_namespace
