"""``ulak sync`` subcommand parser — Skill Sync.
...
def build_sync_parser(subparsers, *, cmd_sync: Callable) -> None:
    ...
    sync_parser = subparsers.add_parser(
        ...
        epilog="Examples:\n"
            "  ulak sync status            what is synced, and from where\n"
            "  ulak sync enable my-skill   include a skill in your sync\n"
            "  ulak sync now               pull, then push\n"
            "  ulak sync propose my-skill  share a skill with your team\n",
