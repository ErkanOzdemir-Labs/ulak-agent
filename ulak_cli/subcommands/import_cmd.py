...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import", help="Restore a Ulak backup from a zip file",
        description="Extract a previously created Ulak backup into your "
        "Ulak home directory, restoring configuration, skills, "
        "sessions, and data")
