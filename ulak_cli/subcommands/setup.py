...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure Ulak Agent with an interactive wizard. "
        "Run a specific section: "
        "ulak setup model|tts|terminal|gateway|tools|telemetry|agent")
    ...
    setup_parser.add_argument(
        ...
        "compatibility — a bare 'ulak setup' now does this.")
    setup_parser.add_argument(
