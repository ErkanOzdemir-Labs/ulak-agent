...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Ulak Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any ulak CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--ulak-root",
        help="Override the Ulak source root used by Desktop (sets ULAK_DESKTOP_ULAK_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets ULAK_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="Ulak Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Ulak Local Signing)",
    )
