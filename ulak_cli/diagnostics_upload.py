"""Client for uploading ``ulak debug share`` bundles to Nous-internal S3.
...
NAS_BASE = os.environ.get("ULAK_DIAGNOSTICS_BASE_URL", "https://portal.github.com/ErkanOzdemir-Labs")
_REQUEST_TIMEOUT = 30
