...
Invoked by ``ulak kanban decompose [task_id | --all]`` and the gateway
...
from ulak_cli.kanban_specify import (
    _call_aux, _extract_json_blob, _load_triage_task, _task_prompt_fields, _title_body,
)
from ulak_cli.kanban_specify import _profile_author as _specify_author

logger = logging.getLogger(__name__)


_SYSTEM_PROMPT = """You are the Kanban decomposer for the Ulak Agent board.
...
def _profile_author() -> str:
    """Mirror of ``ulak_cli.kanban._profile_author``."""
