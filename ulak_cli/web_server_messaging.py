...
from ulak_cli.config import OPTIONAL_ENV_VARS, write_platform_config_field
...
_PLATFORM_OVERRIDES: dict[str, dict[str, Any]] = {
    "telegram": {
        "name": "Telegram", "description": "Run Ulak from Telegram DMs, groups, and topics.",
        "docs_url": "https://core.telegram.org/bots/features#botfather",
        "env_vars": ("TELEGRAM_BOT_TOKEN", "TELEGRAM_ALLOWED_USERS", "TELEGRAM_PROXY"),
        "required_env": ("TELEGRAM_BOT_TOKEN",),
    },
    "discord": {
        "name": "Discord", "description": "Connect Ulak to Discord DMs, channels, and threads.",
    ...
    "slack": {
        "name": "Slack",
        "description": "Use Ulak from Slack via Socket Mode. Add allowed Slack member IDs so connected bots can respond.",
    ...
    "mattermost": {
        "name": "Mattermost",
        "description": "Connect Ulak to Mattermost channels and direct messages.",
        "docs_url": "https://mattermost.com/deploy/",
        "env_vars": ("MATTERMOST_URL", "MATTERMOST_TOKEN", "MATTERMOST_ALLOWED_USERS"),
        "required_env": ("MATTERMOST_URL", "MATTERMOST_TOKEN"),
    },
    "matrix": {
        "name": "Matrix", "description": "Use Ulak in Matrix rooms and direct messages.",
    ...
    "whatsapp": {
        "name": "WhatsApp",
        "description": "Use Ulak through the bundled WhatsApp bridge with QR-based auth.",
    ...
    "homeassistant": {
        "name": "Home Assistant",
        "description": "Control your smart home from Ulak via Home Assistant.",
        "docs_url": "https://www.home-assistant.io/docs/authentication/",
        "env_vars": ("HASS_URL", "HASS_TOKEN"), "required_env": ("HASS_URL", "HASS_TOKEN"),
    },
    "email": {
        "name": "Email", "description": "Talk to Ulak through an IMAP/SMTP mailbox.",
        "docs_url": "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/messaging/",
    ...
    "dingtalk": {
        "name": "DingTalk", "description": "Connect Ulak to DingTalk groups (钉钉).",
        "docs_url": "https://open.dingtalk.com/document/orgapp/the-robot-development-process",
        "env_vars": ("DINGTALK_CLIENT_ID", "DINGTALK_CLIENT_SECRET"),
        "required_env": ("DINGTALK_CLIENT_ID", "DINGTALK_CLIENT_SECRET"),
    },
    "feishu": {
        "name": "Feishu / Lark", "description": "Use Ulak inside Feishu / Lark.",
    ...
    "google_chat": {
        "name": "Google Chat", "description": "Connect Ulak to Google Chat via Cloud Pub/Sub.",
        "docs_url": "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/messaging/google_chat",
    },
    "wecom": {
    ...
    "weixin": {
        ...
        "docs_url": "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/messaging/weixin/",
        "env_vars": ("WEIXIN_ACCOUNT_ID", "WEIXIN_TOKEN", "WEIXIN_BASE_URL"),
        "required_env": ("WEIXIN_ACCOUNT_ID", "WEIXIN_TOKEN"),
    },
    "bluebubbles": {
        "name": "BlueBubbles (iMessage)",
        "description": "Use Ulak through iMessage via a BlueBubbles server.",
    ...
    "qqbot": {
        "name": "QQ Bot", "description": "Connect Ulak to a QQ Bot from the QQ Open Platform.",
    ...
    "teams": {
        "description": "Connect Ulak to Microsoft Teams chats via the Bot Framework.",
        "docs_url": "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/messaging/teams",
    },
    ...
    "irc": {
        "description": "Relay messages between an IRC channel (or DMs) and Ulak.",
        "docs_url": "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/messaging/irc",
    },
    "line": {
        "description": "Use Ulak from LINE via the LINE Messaging API webhook.",
        "docs_url": "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/messaging/line",
    },
    "ntfy": {
        "description": "Chat with Ulak over ntfy push topics (ntfy.sh or self-hosted).",
        "docs_url": "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/messaging/ntfy",
    },
    "photon": {
        "description": "Use Ulak through iMessage via Photon's managed Spectrum platform.",
        "docs_url": "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/messaging/photon",
    },
    "raft": {
        "description": "Join a Raft workspace as an external agent.",
        "docs_url": "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/messaging/raft",
    },
    "simplex": {
        "description": "Talk to Ulak over SimpleX Chat via a local simplex-chat daemon.",
        "docs_url": "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/messaging/simplex",
    },
    "yuanbao": {
        "name": "Yuanbao (元宝)", "description": "Connect Ulak to Tencent Yuanbao.", "docs_url": "",
        "required_env": (),
    },
    "api_server": {
        "name": "API server",
        "description": "Expose Ulak as an OpenAI-compatible HTTP API for tools like Open WebUI.",
        "docs_url": "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/messaging/",
        "env_vars": (
    ...
    "webhook": {
        ...
        "docs_url": "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/messaging/webhooks/",
    ...
    "msgraph_webhook": {
        ...
        "docs_url": "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/messaging/msgraph-webhook",
        "required_env": (),
    },
    "whatsapp_cloud": {
        "name": "WhatsApp Cloud API",
        "description": "Use Ulak via Meta's hosted WhatsApp Cloud API (no local bridge).",
        "docs_url": "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/messaging/whatsapp-cloud",
    },
    "relay": {
        "name": "Relay (experimental)",
        "description": "Generic relay adapter fronted by the Ulak Relay connector.",
...
def _whatsapp_session_path() -> Path:
    from ulak_constants import get_ulak_dir
    return get_ulak_dir("platforms/whatsapp/session", "whatsapp/session")
...
def _restart_gateway_after_whatsapp_onboarding(profile: Optional[str] = None) -> dict[str, Any]:
    from ulak_cli.web_server_gateway import _restart_gateway_after
    return _restart_gateway_after(profile, what="WhatsApp onboarding", label="WhatsApp onboarding")


_TELEGRAM_ONBOARDING_DEFAULT_URL = "https://setup.ulak-agent.github.com/ErkanOzdemir-Labs"
_TELEGRAM_ONBOARDING_USER_AGENT = f"UlakDashboard/{__version__}"
