"""Ulak middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "ulak.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "ulak.middleware.v1"
...
def _apply_request_chain(
    ...
    from ulak_cli.plugins import invoke_middleware
...
def apply_llm_request_middleware(request: Dict[str, Any], **context: Any) -> RequestMiddlewareResult:
    ...
    from ulak_cli.plugins import has_middleware
