...
Pure leaf: imports nothing from ``ulak_cli.auth`` so the per-provider modules
...
# httpx is imported lazily (~30ms) because ulak_cli.auth is on the interactive-CLI startup path
...
if TYPE_CHECKING:
    ...
    class _LazyHttpx:
        ...
        # set/del forward to the real module so monkeypatch.setattr("ulak_cli.auth.httpx.Client")
...
DEFAULT_NOUS_INFERENCE_URL = "https://inference-api.github.com/ErkanOzdemir-Labs/v1"
DEFAULT_NOUS_CLIENT_ID = "ulak-cli"
...
try:  # Version tag for the Codex token-endpoint User-Agent; fall back if unavailable.
    from ulak_cli import __version__ as _ULAK_CLI_VERSION
except Exception:  # pragma: no cover - version import should always succeed
    _ULAK_CLI_VERSION = "unknown"
CODEX_OAUTH_USER_AGENT = f"ulak-cli/{_ULAK_CLI_VERSION}"
...
SPOTIFY_DOCS_URL = "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/features/spotify"
SPOTIFY_DASHBOARD_URL = "https://developer.spotify.com/dashboard"
SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS = 120

OAUTH_OVER_SSH_DOCS_URL = "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/guides/oauth-over-ssh"
