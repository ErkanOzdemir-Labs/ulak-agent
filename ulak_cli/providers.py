"""Single source of truth for provider identity in Ulak Agent."""
...
# -- Ulak overlay: metadata models.dev doesn't provide ----------------------

@dataclass(frozen=True)
class UlakOverlay:
    """Ulak-specific provider metadata layered on top of models.dev."""
...
ULAK_OVERLAYS: Dict[str, UlakOverlay] = {
    "moa": UlakOverlay(auth_type="virtual", base_url_override="moa://local"),
    "openrouter": UlakOverlay(is_aggregator=True, base_url_env_var="OPENROUTER_BASE_URL"),
    "nous": UlakOverlay(auth_type="oauth_device_code", base_url_override="https://inference-api.github.com/ErkanOzdemir-Labs/v1"),
    "openai-codex": UlakOverlay(transport="codex_responses", auth_type="oauth_external",
                                  base_url_override="https://chatgpt.com/backend-api/codex"),
    "openai-api": UlakOverlay(transport="codex_responses", base_url_override="https://api.openai.com/v1",
                                base_url_env_var="OPENAI_BASE_URL"),
    "xai-oauth": UlakOverlay(transport="codex_responses", auth_type="oauth_external",
                               base_url_override="https://api.x.ai/v1", base_url_env_var="XAI_BASE_URL"),
    "qwen-oauth": UlakOverlay(auth_type="oauth_external", base_url_override="https://portal.qwen.ai/v1",
                                base_url_env_var="ULAK_QWEN_BASE_URL"),
    "lmstudio": UlakOverlay(extra_env_vars=("LM_API_KEY",), base_url_override="http://127.0.0.1:1234/v1",
                              base_url_env_var="LM_BASE_URL"),
    "copilot-acp": UlakOverlay(transport="codex_responses", auth_type="external_process",
                                 base_url_override="acp://copilot", base_url_env_var="COPILOT_ACP_BASE_URL"),
    "github-copilot": UlakOverlay(extra_env_vars=("COPILOT_GITHUB_TOKEN", "GH_TOKEN")),
    "anthropic": UlakOverlay(transport="anthropic_messages", extra_env_vars=("ANTHROPIC_TOKEN", "CLAUDE_CODE_OAUTH_TOKEN")),
    "zai": UlakOverlay(extra_env_vars=("GLM_API_KEY", "ZAI_API_KEY", "Z_AI_API_KEY"), base_url_env_var="GLM_BASE_URL"),
    "kimi-for-coding": UlakOverlay(base_url_env_var="KIMI_BASE_URL"),
    "stepfun": UlakOverlay(extra_env_vars=("STEPFUN_API_KEY",),
                             base_url_override="https://api.stepfun.ai/step_plan/v1",
                             base_url_env_var="STEPFUN_BASE_URL"),
    "minimax": UlakOverlay(transport="anthropic_messages", base_url_env_var="MINIMAX_BASE_URL"),
    "minimax-oauth": UlakOverlay(transport="anthropic_messages", auth_type="oauth_external",
                                   base_url_override="https://api.minimax.io/anthropic"),
    "minimax-cn": UlakOverlay(transport="anthropic_messages", base_url_env_var="MINIMAX_CN_BASE_URL"),
    "deepseek": UlakOverlay(base_url_env_var="DEEPSEEK_BASE_URL"),
    "alibaba": UlakOverlay(base_url_env_var="DASHSCOPE_BASE_URL"),
    "alibaba-coding-plan": UlakOverlay(base_url_env_var="ALIBABA_CODING_PLAN_BASE_URL"),
    "vercel": UlakOverlay(is_aggregator=True),
    "opencode": UlakOverlay(is_aggregator=True, base_url_env_var="OPENCODE_ZEN_BASE_URL"),
    "opencode-go": UlakOverlay(is_aggregator=True, base_url_env_var="OPENCODE_GO_BASE_URL"),
    "opencode-free": UlakOverlay(is_aggregator=True, base_url_override="https://opencode.ai/zen/v1", keyless=True),
    "kilo": UlakOverlay(is_aggregator=True, base_url_env_var="KILOCODE_BASE_URL"),
    "huggingface": UlakOverlay(is_aggregator=True, base_url_env_var="HF_BASE_URL"),
    "novita": UlakOverlay(is_aggregator=True, base_url_env_var="NOVITA_BASE_URL"),
    "xai": UlakOverlay(transport="codex_responses", base_url_override="https://api.x.ai/v1", base_url_env_var="XAI_BASE_URL"),
    "nvidia": UlakOverlay(base_url_override="https://integrate.api.nvidia.com/v1", base_url_env_var="NVIDIA_BASE_URL"),
    "xiaomi": UlakOverlay(base_url_env_var="XIAOMI_BASE_URL"),
    "tencent-tokenhub": UlakOverlay(base_url_env_var="TOKENHUB_BASE_URL"),
    "tencent-tokenplan": UlakOverlay(transport="anthropic_messages",
                                       base_url_override="https://api.lkeap.cloud.tencent.com/plan/anthropic",
                                       base_url_env_var="TOKENPLAN_BASE_URL"),
    "arcee": UlakOverlay(base_url_override="https://api.arcee.ai/api/v1", base_url_env_var="ARCEE_BASE_URL"),
    "gmi": UlakOverlay(extra_env_vars=("GMI_API_KEY",), base_url_override="https://api.gmi-serving.com/v1",
                         base_url_env_var="GMI_BASE_URL"),
    "fireworks": UlakOverlay(extra_env_vars=("FIREWORKS_API_KEY",),
                               base_url_override="https://api.fireworks.ai/inference/v1"),
    "actual": UlakOverlay(transport="codex_responses", extra_env_vars=("ACTUAL_API_KEY", "ACTUAL_BASE_URL"),
                            base_url_override="https://api.actual.inc/v1", base_url_env_var="ACTUAL_BASE_URL"),
    "upstage": UlakOverlay(extra_env_vars=("UPSTAGE_API_KEY",), base_url_override="https://api.upstage.ai/v1",
                             base_url_env_var="UPSTAGE_BASE_URL"),
    "nebius-token-factory": UlakOverlay(extra_env_vars=("NEBIUS_API_KEY", "NEBIUS_TOKEN_FACTORY_API_KEY"),
                                          base_url_override="https://api.tokenfactory.nebius.com/v1",
                                          base_url_env_var="NEBIUS_BASE_URL"),
    "ollama-cloud": UlakOverlay(base_url_override="https://ollama.com/v1", base_url_env_var="OLLAMA_BASE_URL"),
    # Azure Foundry serves OpenAI- and Anthropic-style endpoints; transport comes from model.api_mode.
    "azure-foundry": UlakOverlay(base_url_env_var="AZURE_FOUNDRY_BASE_URL"),
    "bedrock": UlakOverlay(transport="bedrock_converse", auth_type="aws_sdk"),
    ...
    "vertex": UlakOverlay(auth_type="vertex"),
}
...
class ProviderDef:
    ...
    doc: str = ""
    source: str = ""                      # "models.dev", "ulak", "user-config"
...
def _overlay_pdef(canonical, ov: UlakOverlay, name, env_vars, base_url, doc, source) -> ProviderDef:
...
def get_provider(name: str, *, allow_network: bool = True) -> Optional[ProviderDef]:
    """Look up a built-in provider by id or alias: models.dev catalog merged with the Ulak overlay;
    Ulak-only overlay (nous, openai-codex, …); plugin provider profiles with a concrete endpoint."""
    canonical = normalize_provider(name)
    mdev_info = _models_dev_info(canonical, allow_network)
    overlay = ULAK_OVERLAYS.get(canonical)
    if mdev_info is not None:
        ov = overlay or UlakOverlay()
    ...
    if overlay is not None:
        return _overlay_pdef(canonical, overlay, _LABEL_OVERRIDES.get(canonical, canonical), overlay.extra_env_vars,
                             overlay.base_url_override, "", "ulak")
    # Plugin-registered profiles (plugins/model-providers/<name>/) absent from models.dev and
    # ULAK_OVERLAYS would otherwise be "Unknown provider" in /model, --provider and model-switch
...
def nous_api_mode(model: str = "") -> str:
    ...
    (ErkanOzdemir-Labs/api#227 carries the diagnostics); flip the default back to ``native`` when it is
...
def determine_api_mode(provider: str, base_url: str = "", model: str = "") -> str:
    ...
    if mandated is not None:
        return mandated
    if (provider or "").strip().lower() in {"nous", "nous-portal", "erkanozdemir-labs"}:
...
def _lossy_alias_registry_pdef(raw: str, canonical: str) -> Optional[ProviderDef]:
    """Exact Ulak registry ids win over LOSSY alias collapsing (kimi-coding-cn must stay distinct
    ...
    try:
        from ulak_cli.auth import PROVIDER_REGISTRY as _AUTH_PROVIDER_REGISTRY
...
def _llamacpp_pdef() -> Optional[ProviderDef]:
    ...
    try:
        from ulak_cli.local_runtime.endpoint import resolve_llamacpp_endpoint
