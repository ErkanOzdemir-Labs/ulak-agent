...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Ulak to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Ulak needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Ulak gateway in another terminal:",
        "         ulak gateway", "",
    ...
    _lines(
        ...
        "  Docs: https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/user-guide/",
