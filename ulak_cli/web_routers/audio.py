...
from ulak_cli.web_server_chat import _ws_auth_ok, _ws_request_is_allowed
from ulak_cli.web_server_gateway import _split_text_for_speak_stream
from fastapi import HTTPException, WebSocket, WebSocketDisconnect
from ulak_cli.web_models import AudioTranscriptionRequest, TTSSpeakRequest, TTSLeaseRequest
    ...
    try:
        with http_failure("Desktop voice transcription failed", 500, "Transcription failed"):
            with tempfile.NamedTemporaryFile(
                prefix="ulak-desktop-voice-", suffix=_audio_extension_for_mime(mime_type),
                delete=False,
            ) as tmp:
