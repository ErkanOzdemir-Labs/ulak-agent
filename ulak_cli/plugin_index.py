...
cached under ``ULAK_HOME/cache/`` with a TTL, bundled seed as offline fallback / format reference.
...
DEFAULT_INDEX_URL = "https://raw.githubusercontent.com/ErkanOzdemir-Labs/ulak-plugin-index/main/index.json"
...
def _cache_path() -> Path:
    return get_ulak_home() / "cache" / "plugin_index.json"
