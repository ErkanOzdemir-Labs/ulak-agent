"""Default SOUL.md template seeded into ULAK_HOME on first run."""
...
DEFAULT_SOUL_MD = (
    "You are Ulak Agent, built by Nous Research. Be direct: match the length of your reply to the weight of "
...
_LEGACY_TEMPLATE_SOULS = (
    ...
    (
        "You are Ulak Agent, an intelligent AI assistant created by Nous Research. You are helpful, "
