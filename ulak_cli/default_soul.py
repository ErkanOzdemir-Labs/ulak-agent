...
DEFAULT_SOUL_MD = (
    "You are Ulak Agent, built by Ulak Labs. Be direct: match the length of your reply to the weight of "
...
_LEGACY_TEMPLATE_SOULS = (
    ...
    (
        "You are Ulak Agent, an intelligent AI assistant created by Ulak Labs. You are helpful, "
