"""Shared migration guards for Ulak' native NeMo Relay ownership."""
...
RELAY_PLUGINS_CONFIG_ENV = "ULAK_NEMO_RELAY_PLUGINS_TOML"

LEGACY_RELAY_PLUGIN_KEYS = frozenset({"nemo_relay", "observability/nemo_relay"})

LEGACY_RELAY_EXPORT_ENV_VARS = frozenset({
    "ULAK_NEMO_RELAY_ATOF_ENABLED",
    "ULAK_NEMO_RELAY_ATOF_OUTPUT_DIRECTORY",
    "ULAK_NEMO_RELAY_ATOF_FILENAME",
    "ULAK_NEMO_RELAY_ATOF_MODE",
    "ULAK_NEMO_RELAY_ATIF_ENABLED",
    "ULAK_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY",
    "ULAK_NEMO_RELAY_ATIF_FILENAME_TEMPLATE",
    "ULAK_NEMO_RELAY_ATIF_AGENT_NAME",
    "ULAK_NEMO_RELAY_ATIF_AGENT_VERSION",
    "ULAK_NEMO_RELAY_ATIF_EXPORT_TIMEOUT_S",
    "ULAK_NEMO_RELAY_ATIF_MODEL_NAME",
    "ULAK_NEMO_RELAY_ATIF_SUBAGENT_EXPORT_MODE",
})
