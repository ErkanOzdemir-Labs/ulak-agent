"""Ulak skin/theme engine — the theme SDK for every surface."""
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces ULAK_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces ULAK_CADUCEUS)
...
# Branding shared by every Ulak-named built-in (mono/daylight override help_header).
_ULAK_BRANDING: Dict[str, str] = _branding(
    "Ulak", "⚕", "Goodbye! ⚕", prompt="❯", help_header="(^_^)? Available Commands")

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default", "description": "Classic Ulak — gold and kawaii",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_ULAK_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _ULAK_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
