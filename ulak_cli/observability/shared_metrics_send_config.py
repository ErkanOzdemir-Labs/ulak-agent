...
#: environment variable: AGENTS.md reserves ULAK_* for secrets, and an inherited variable
...
DEFAULT_ENDPOINT = "https://telemetry.github.com/ErkanOzdemir-Labs/v1/telemetry"
