  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Ulak Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Ulak &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Ulak?{' '}
        <a
          href="https://github.com/ErkanOzdemir-Labs/ulak-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
