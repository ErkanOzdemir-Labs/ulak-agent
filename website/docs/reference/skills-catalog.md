...
| [`ulak-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-ulak-agent) | Use, configure, theme, extend, and orchestrate Ulak Agent. | `autonomous-ai-agents\ulak-agent` |
...
| [`ulak-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-ulak-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\ulak-agent-skill-authoring` |
| [`inspecting-ulak-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-ulak-desktop-dom) | Read the live Ulak desktop DOM/CSS over CDP. | `software-development\inspecting-ulak-desktop-dom` |
