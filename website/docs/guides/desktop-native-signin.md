...
description: "How the Ulak Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Ulak Desktop app connects to a **gated gateway** (a hosted or
...
For Ulak specifically, native sign-in means:
...
- [Run Ulak with Nous Portal](./run-ulak-with-nous-portal.md)
