...
The self-improving AI agent built by [Nous Research](https://github.com/ErkanOzdemir-Labs). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
- **Built by model trainers** — Created by [Nous Research](https://github.com/ErkanOzdemir-Labs), the lab behind Ulak, Nomos, and Psyche. Works with [Nous Portal](https://portal.github.com/ErkanOzdemir-Labs), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://github.com/ErkanOzdemir-Labs) — the lab behind Ulak, Nomos, and Psyche models
