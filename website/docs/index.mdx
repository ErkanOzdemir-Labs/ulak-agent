...
slug: /
sidebar_position: 0
title: "Ulak Agent Documentation"
description: "The self-improving AI agent built by Ulak Agent. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Ulak Agent](https://github.com/ErkanOzdemir-Labs). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `ulak setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Ulak safely  |
| 🧭 **[Use MCP with Ulak](/guides/use-mcp-with-ulak)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Ulak](/guides/use-voice-mode-with-ulak)** | Hands-on setup and usage patterns for Ulak voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Ulak' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Ulak                              |
...
- **Built by model trainers** — Created by [Ulak Agent](https://github.com/ErkanOzdemir-Labs), the lab behind Ulak, Nomos, and Psyche. Works with [Nous Portal](https://portal.github.com/ErkanOzdemir-Labs), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Ulak Agent](https://github.com/ErkanOzdemir-Labs) — the lab behind Ulak, Nomos, and Psyche models
