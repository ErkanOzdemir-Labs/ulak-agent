...
Script path: `~/.ulak/skills/maps/scripts/maps_client.py`

## Commands

```bash
MAPS=~/.ulak/skills/maps/scripts/maps_client.py
```
...
```bash
python ~/.ulak/skills/maps/scripts/maps_client.py search "Statue of Liberty"
# Should return lat ~40.689, lon ~-74.044

python ~/.ulak/skills/maps/scripts/maps_client.py nearby --near "Times Square" --category restaurant --limit 3
