...
| | |
|---|---|
| Source | Optional — install with `ulak skills install official/creative/ascii-art` |
| Path | `optional-skills/creative\ascii-art` |
| Version | `4.0.0` |
| Author | 0xbyt4, Ulak Agent |
| License | MIT |
...
```bash
python -m pyfiglet "ULAK" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ULAK&font=Slant" | boxes -d stone
```
