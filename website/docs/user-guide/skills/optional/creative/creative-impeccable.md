...
| | |
|---|---|
| Source | Optional — install with `ulak skills install official/creative/impeccable` |
...
> ships and verifies a Ulak-native skill bundle under `.ulak/skills/`.
> `ulak skills install impeccable` pulls the current bundle live from that
