...
| | |
|---|---|
| Source | Optional — install with `ulak skills install official/web-development/page-agent` |
...
- User wants **Ulak itself to drive a browser** → use Ulak' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
