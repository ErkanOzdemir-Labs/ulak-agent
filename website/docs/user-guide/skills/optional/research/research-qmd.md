...
| | |
|---|---|
| Source | Optional — install with `ulak skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`ulak-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-ulak-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Ulak Agent via the native MCP client. This is the preferred
...
Then configure Ulak Agent to connect via HTTP:
