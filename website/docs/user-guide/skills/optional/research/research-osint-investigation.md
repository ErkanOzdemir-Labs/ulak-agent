...
| | |
|---|---|
| Source | Optional — install with `ulak skills install official/research/osint-investigation` |
| Path | `optional-skills/research\osint-investigation` |
| Version | `0.1.0` |
| Author | Ulak Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $ULAK_OSINT_CACHE/icij/ (default: ~/.cache/ulak-osint/icij/).
...
# Set ULAK_OSINT_UA=your-app/1.0 (your@email) to identify yourself
