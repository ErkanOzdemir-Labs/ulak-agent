...
| | |
|---|---|
| Source | Optional — install with `ulak skills install official/productivity/decision-questionnaire` |
| Path | `optional-skills/productivity\decision-questionnaire` |
| Version | `1.0.0` |
| Author | Matt Pocock (mattpocock/skills, to-questionnaire) + Ulak Agent |
| License | MIT |
