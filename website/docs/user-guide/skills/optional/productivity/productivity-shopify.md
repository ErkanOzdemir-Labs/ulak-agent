...
| | |
|---|---|
| Source | Optional — install with `ulak skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Ulak","productType":"Apparel","tags":["test"]}}'
```
