...
| | |
|---|---|
| Source | Optional — install with `ulak skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing ulak tool access (web_search, file ops). Stateless. |
