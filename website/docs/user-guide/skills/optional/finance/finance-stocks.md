...
| | |
|---|---|
| Source | Optional — install with `ulak skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Ulak Agent |
| License | MIT |
...
```
SCRIPT=~/.ulak/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.ulak/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
