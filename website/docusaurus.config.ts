...
const config: Config = {
  ...
  url: 'https://ulak-agent.github.com/ErkanOzdemir-Labs',
  baseUrl: '/docs/',

  organizationName: 'ErkanOzdemir-Labs',
  projectName: 'ulak-agent',
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-ulak-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/ErkanOzdemir-Labs/ulak-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/ulak-agent-banner.png',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://ulak-agent.github.com/ErkanOzdemir-Labs/',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://github.com/ErkanOzdemir-Labs/ulak-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://discord.gg/ErkanOzdemir-Labs',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/ErkanOzdemir-Labs' },
            { label: 'GitHub Issues', href: 'https://github.com/ErkanOzdemir-Labs/ulak-agent/issues' },
