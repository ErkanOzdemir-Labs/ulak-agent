...
由 [Nous Research](https://github.com/ErkanOzdemir-Labs) 构建的自我改进 AI 智能体。唯一内置学习循环的智能体——它从经验中创建技能，在使用过程中持续改进，主动提示自身持久化知识，并在会话间不断深化对你的建模。
...
- **由模型训练者构建** — 由 [Nous Research](https://github.com/ErkanOzdemir-Labs) 创建，该实验室是 Ulak、Nomos 和 Psyche 背后的团队。支持 [Nous Portal](https://portal.github.com/ErkanOzdemir-Labs)、[OpenRouter](https://openrouter.ai)、OpenAI 或任意端点
...
- **研究就绪** — 批处理、轨迹导出、基于 Atropos 的 RL 训练。由 [Nous Research](https://github.com/ErkanOzdemir-Labs) 构建——该实验室是 Ulak、Nomos 和 Psyche 模型背后的团队
