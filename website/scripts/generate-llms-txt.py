#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Ulak docs site.
...
LLM reads to learn what Ulak does.

Both publish at:
  https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/llms.txt
  https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/llms-full.txt
...
SITE_BASE = "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Ulak as a Python Library", None),
        ("guides/use-mcp-with-ulak", "Use MCP with Ulak", None),
        ("guides/use-voice-mode-with-ulak", "Use Voice Mode with Ulak", None),
        ("guides/use-soul-with-ulak", "Use SOUL.md with Ulak", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Ulak"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Ulak Agent")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Ulak Labs. A terminal-native "
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/ErkanOzdemir-Labs/"
        "ulak-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/ErkanOzdemir-Labs/ulak-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Ulak Agent — Full Documentation\n",
        (
            "This file is the entire Ulak Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Ulak, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://ulak-agent.github.com/ErkanOzdemir-Labs/docs\n",
        "Short index: https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/llms.txt\n",
        "\n---\n\n",
    ]
