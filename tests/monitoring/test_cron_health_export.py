...
def test_registered_observable_metric_names_cover_snapshot_metrics(monkeypatch):
    ...
    gateway_snapshot = type("S", (), {"metrics": [
        _M("ulak.gateway.up"), _M("ulak.gateway.active_agents"),
        _M("ulak.gateway.busy"), _M("ulak.gateway.drainable"),
        _M("ulak.gateway.restart_requested"),
        _M("ulak.platform.up"), _M("ulak.platform.degraded"),
    ]})()
    cron_snapshot = type("S", (), {"metrics": [
        _M("ulak.cron.scheduler.heartbeat_age_seconds"),
        _M("ulak.cron.scheduler.last_success_age_seconds"),
        _M("ulak.cron.scheduler.catch_up_occurrences"),
        _M("ulak.cron.jobs.enabled"), _M("ulak.cron.jobs.running"),
        _M("ulak.cron.jobs.overdue"),
    ]})()
...
def test_monitoring_docs_distinguish_relay_health_scope_and_terminal_flush():
    ...
    assert "Ulak Agent-owned Relay transport health" in text
