...
def make_ulak_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated ULAK_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"ulak-home-{journal_mode}"
