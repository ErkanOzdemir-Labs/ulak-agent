...
class TestStripBlockedTools(unittest.TestCase):
    ...
    def test_mixed_composite_is_subtracted_at_child_assembly(self):
        ...
        ``ulak-cli`` contains both allowed tools and every sensitive
        ...
        parent.enabled_toolsets = ["ulak-cli"]
...
class TestDelegateTask(unittest.TestCase):
    ...
    def test_nous_child_rederives_api_mode_from_model(self):
        ...
        with patch("ulak_cli.providers._nous_anthropic_wire", return_value="native"):
            self._nous_child_rederives_api_mode_from_model()

    def _nous_child_rederives_api_mode_from_model(self):
        parent = _make_mock_parent(depth=0)
        parent.base_url = "https://inference-api.github.com/ErkanOzdemir-Labs/v1"
        ...
        with patch("run_agent.AIAgent") as MockAgent:
            ...
            self.assertEqual(kwargs["model"], "ulak-4-405b")
...
class TestConcurrencyDefaults(unittest.TestCase):
    ...
    def test_load_config_prefers_active_persistent_config_over_cli_defaults(self):
        ...
        with patch.dict("sys.modules", {"cli": stale_cli}):
            with patch(
                "ulak_cli.config.load_config_readonly", return_value=active_config
            ):
