...
def _set_xai_oauth_unavailable(monkeypatch):
    ...
    import ulak_cli.auth_xai as auth_xai
...
def test_prefer_api_key_honors_ulak_xai_base_url_with_validation(monkeypatch):
    """The preferred-key path reads the same override pair as the OAuth
    branch (ULAK_XAI_BASE_URL first, then XAI_BASE_URL) behind the same
    ...
    monkeypatch.setattr(
        ...
        lambda name, default=None: {
            ...
            "ULAK_XAI_BASE_URL": "https://staging.x.ai/v1",
