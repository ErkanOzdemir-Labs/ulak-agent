...
class TestScanMemoryContent:
    def test_clean_content_and_false_positives_pass(self):
        ...
        # Mentioning agent/ulak config files without modify intent.
        ...
        assert _scan_memory_content("Read .ulak/SOUL.md for agent personality") is None
        assert _scan_memory_content("Check .ulak/config.yaml for settings") is None
        # 'send' without a URL.
    ...
    def test_persistence_patterns_blocked(self):
        ...
        _blocked("edit .ulak/config.yaml to change settings", "ulak_config_mod")
        _blocked("update .ulak/SOUL.md with new personality", "ulak_config_mod")
