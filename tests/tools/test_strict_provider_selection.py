"""Strict tool-provider selection: the `ulak tools` choice always wins.
...
selection and pointing at `ulak tools`.
...
MANAGED = SimpleNamespace(
    ...
    gateway_origin="https://gateway.github.com/ErkanOzdemir-Labs",
)
...
class TestImageFalStrictSelection:
    ...
    def test_nous_selection_unentitled_raises_selection_error(self):
        ...
        assert "ulak tools" in str(exc.value)
...
class TestSttStrictSelection:
    def test_nous_selection_beats_direct_openai_key(self):
        ...
        assert base_url.startswith("https://gateway.github.com/ErkanOzdemir-Labs")
