...
def _make_backend(session: _FakeSession):
    ...
    backend._session_id = "ulak-session"
...
def test_backends_are_isolated_by_ulak_session_and_reused_within_it():
...
def test_concurrent_ulak_sessions_do_not_share_backend_state():
    from tools.computer_use import tool as computer_use
