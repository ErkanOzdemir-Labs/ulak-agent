"""Session <-> workspace grouping key (ulak_state_sessions.workspace_key).

The key is what `ulak sessions list --workspace` groups/filters on. It is a
...
import ulak_state_sessions
from ulak_state_sessions import workspace_key
