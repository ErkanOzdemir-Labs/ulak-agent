...
The unit tests in tests/ulak_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned ulak-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/ulak")
from ulak_cli.service_manager import S6ServiceManager
