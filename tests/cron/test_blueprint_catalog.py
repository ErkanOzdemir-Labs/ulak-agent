...
the shared /blueprint command handler (ulak_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated ULAK_HOME for anything that touches the
cron job store.
"""
...
class TestRenderers:
    ...
    def test_deeplink_shape(self):
        ...
        assert url.startswith("ulak://blueprint/morning-brief?")
