...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("ulak_cli.config.get_config_path", return_value=config_path), \
             patch("ulak_cli.config.ensure_ulak_home"):
    ...
    def test_ensure_ulak_home_sets_0700(self):
        home = Path(self.tmpdir) / ".ulak"
        with patch("ulak_cli.config.get_ulak_home", return_value=home):
