"""Tests for the ulak-tools-as-MCP server module surface.
...
from agent.transports.ulak_tools_mcp_server import (
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import ulak_tools_mcp_server as m
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.ulak_tools_mcp_server as m
