...
manipulation. Ulak keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point ULAK_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_ulak_home /
    get_default_ulak_root) instead of monkeypatching private helpers —
    ...
    ULAK_HOME=<root>/profiles/<name> makes get_default_ulak_root()
