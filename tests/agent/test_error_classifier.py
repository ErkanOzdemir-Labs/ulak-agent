        ...
        e = MockAPIError(
            ...
            body={
                ...
                "message": (
                    ...
                    "Upgrade at https://portal.github.com/ErkanOzdemir-Labs or pick a free model."
                ),
            },
        )
        ...
        e = MockAPIError(
            ...
            body={
                ...
                "message": (
                    ...
                    "add credits at https://portal.github.com/ErkanOzdemir-Labs or pick a free model."
                ),
            },
        )
...
class TestServerInjectedParameterRejection:
    ...
    so an identical request succeeds on retry ~80% of the time.  Ulak never
    ...
    def test_retention_rejection_from_meta_host_stays_non_retryable(self):
        """Boundary: on api.meta.ai / Bedrock Mantle Ulak DOES send
