...
thinking phase.  Ulak's default cloud-stream stale detector
(``ULAK_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``ULAK_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
