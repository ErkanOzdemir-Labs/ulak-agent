...
class TestIsFreeTierModel:
    ...
    def test_pricing_cache_peek_zero_priced_model(self, monkeypatch):
        ...
        monkeypatch.setattr(models_pricing, "_pricing_cache",
            {
                "https://inference-api.github.com/ErkanOzdemir-Labs": {
        ...
        base = "https://inference-api.github.com/ErkanOzdemir-Labs/v1"
        ...
        assert is_free_tier_model("some/zero-priced", "https://inference-api.github.com/ErkanOzdemir-Labs/") is True
        assert is_free_tier_model("some/zero-priced", "https://inference-api.github.com/ErkanOzdemir-Labs/v1/") is True
    ...
    def test_exception_fails_open_to_false(self, monkeypatch):
        ...
        assert is_free_tier_model("some/model", "https://inference-api.github.com/ErkanOzdemir-Labs") is False
    ...
    def test_stealth_prefix_detected_as_free(self):
        ...
        assert is_free_tier_model("stealth/ox-alpha", "https://inference-api.github.com/ErkanOzdemir-Labs/v1") is True
