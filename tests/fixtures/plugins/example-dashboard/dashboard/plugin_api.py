...
part of the bundled-plugins set; a stock ulak-agent install does not see
an "Example" tab in its sidebar. The ``_install_example_plugin`` pytest
fixture in ``tests/ulak_cli/test_web_server.py`` copies this directory
into ``$ULAK_HOME/plugins/example-dashboard/`` and forces the dashboard
