...
import ulak_cli.model_switch_providers as ulak_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(ulak_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("ulak_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import ulak_cli.models as hm
    import ulak_cli.models_catalog_static as ulak_cli_models_catalog_static
    from ulak_cli import models_catalog_static
    ...
    monkeypatch.setattr(ulak_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
