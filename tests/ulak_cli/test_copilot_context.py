...
class TestGetCopilotModelContext:
    ...
    @patch("ulak_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("ulak_cli.models._urlopen_model_catalog_request")
    ...
    @patch("ulak_cli.models.fetch_github_model_catalog", return_value=[])
