"""Tests for the ``ulak prompt-size`` diagnostic (issue #34667)."""
...
from ulak_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(ulak_home, memory_text="", user_text=""):
    mem_dir = ulak_home / "memories"
...
def _seed_skill(ulak_home, name, description):
    skill_dir = ulak_home / "skills" / "demo" / name
