"""Tests for `ulak secrets bitwarden token` / `ulak secrets onepassword token`.
...
from ulak_cli import onepassword_secrets_cli as op_cli
from ulak_cli import secrets_cli as bw_cli
