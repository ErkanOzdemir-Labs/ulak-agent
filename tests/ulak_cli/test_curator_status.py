"""Tests for `ulak curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated ULAK_HOME with real agent-created skills on disk."""
    home = tmp_path / ".ulak"
    skills = home / "skills"
    ...
    from ulak_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import ulak_cli.curator as curator_cli
