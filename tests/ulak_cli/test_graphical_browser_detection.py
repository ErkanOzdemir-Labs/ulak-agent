"""Tests for `_can_open_graphical_browser()` in ulak_cli.auth.

Guards the fix for the May 2026 report where `ulak auth add xai-oauth`
...
from ulak_cli.auth import _can_open_graphical_browser
