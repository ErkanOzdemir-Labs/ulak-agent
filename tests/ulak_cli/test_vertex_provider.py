...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (ulak_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_ulak_overlays():
    """ulak_cli.providers.get_provider("vertex") backs
