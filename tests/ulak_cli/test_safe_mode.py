"""Tests for `ulak chat --safe-mode` isolation."""
...
_VARS = ("ULAK_SAFE_MODE", "ULAK_IGNORE_USER_CONFIG", "ULAK_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["ULAK_SAFE_MODE"] == "1"
        assert os.environ["ULAK_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["ULAK_IGNORE_RULES"] == "1"
        return True
