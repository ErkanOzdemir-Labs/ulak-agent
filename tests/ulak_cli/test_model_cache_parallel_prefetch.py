...
import pytest
from ulak_cli import model_switch_providers


# ---------------------------------------------------------------------------
# Thread-safe cache entry update (ulak_cli/models.py)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Parallel prefetch (ulak_cli/model_switch.py)
# ---------------------------------------------------------------------------
...
class TestPrefetchProviderModelsParallel:
    ...
    def test_skips_all_fresh_entries(self, monkeypatch):
        ...
        from ulak_cli.model_switch_providers import _prefetch_provider_models_parallel
        ...
        with patch("ulak_cli.models._load_provider_models_cache", return_value=fresh_cache), \
             patch("ulak_cli.models._credential_fingerprint", return_value="fp"), \
             patch("ulak_cli.models.cached_provider_model_ids") as fetch:
    ...
    def test_fetches_only_stale_entries(self, monkeypatch):
        ...
        with patch("ulak_cli.models._load_provider_models_cache", return_value=cache), \
             patch("ulak_cli.models._credential_fingerprint", return_value="fp_f"), \
             patch("ulak_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("ulak_cli.models.update_provider_cache_entry"):
    ...
    def test_fetches_in_parallel(self, monkeypatch):
        ...
        with patch("ulak_cli.models._load_provider_models_cache", return_value={}), \
             patch("ulak_cli.models._credential_fingerprint", return_value="fp"), \
             patch("ulak_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("ulak_cli.models.update_provider_cache_entry"):
    ...
    def test_empty_list_is_noop(self):
        ...
        with patch("ulak_cli.models.cached_provider_model_ids") as fetch:
