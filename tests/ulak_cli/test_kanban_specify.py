"""Tests for the specifier module + `ulak kanban specify` CLI surface.
...
from ulak_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `ulak kanban …` argparse surface directly."""
