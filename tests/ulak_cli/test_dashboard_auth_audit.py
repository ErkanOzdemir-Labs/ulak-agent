...
Profile-aware location: ``$ULAK_HOME/logs/dashboard-auth.log``.
...
from ulak_cli.dashboard_auth.audit import audit_log, AuditEvent


@pytest.fixture
def profile_home(tmp_path, monkeypatch):
    """Redirect $ULAK_HOME and ~ to a tmp dir for the duration of the test."""
    home = tmp_path / ".ulak"
    home.mkdir()
