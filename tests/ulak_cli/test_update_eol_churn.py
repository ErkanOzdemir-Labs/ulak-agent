"""Regression: ``ulak update`` should take a managed checkout off autocrlf=true.
...
``ulak update`` has to repair them.
...
from ulak_cli.update_cmd import _normalize_managed_eol
