"""Tests for ``ulak approvals suggest`` (ulak_cli/approvals_suggest.py).

Approval history in Ulak is implied, not ledgered: the session DB
...
from ulak_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
