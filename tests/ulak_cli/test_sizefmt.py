"""Tests for the shared byte formatter (ulak_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from ulak_cli.backup import _format_size as backup
    from ulak_cli.checkpoints import _fmt_bytes as checkpoints
    from ulak_cli.sizefmt import format_bytes as doctor
