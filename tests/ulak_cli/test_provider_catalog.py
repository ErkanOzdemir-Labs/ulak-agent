"""Tests for the unified provider catalog (ulak_cli.provider_catalog).

These are invariant tests, not snapshots: they assert the parity *contract*
between what ``ulak model`` shows (``CANONICAL_PROVIDERS``) and what the
...
from ulak_cli.provider_catalog import (
    ProviderDescriptor,
    provider_catalog,
