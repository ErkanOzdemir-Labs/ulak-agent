...
Run before any catalog commit:
    ...
    ULAK_TEST_NETWORK=1 scripts/run_tests.sh tests/ulak_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("ULAK_TEST_NETWORK"),
    reason="network test; set ULAK_TEST_NETWORK=1 to run",
)
