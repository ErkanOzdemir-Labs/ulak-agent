"""Fetch-failure classification for `ulak update` / `ulak update --check`.
...
CURL_429_STDERR = (
    "fatal: unable to access 'https://github.com/ErkanOzdemir-Labs/ulak-agent.git/':"
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `ulak update` sit on
    ...
    from ulak_cli import update_cmd_git
