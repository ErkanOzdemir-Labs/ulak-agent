...
def cold_cache(monkeypatch):
    ...
    from ulak_cli import models_reasoning_caps
...
class TestNousModelReasoningCapabilities:
    def test_fetch_parses_mandatory_flag(self, cold_cache, monkeypatch):
        from ulak_cli.models_reasoning_caps import nous_model_reasoning_capabilities
    ...
    def test_catalog_read_follows_the_configured_endpoint(
        ...
        """
        from ulak_cli.models_reasoning_caps import nous_catalog_url

        monkeypatch.setenv(
            "NOUS_INFERENCE_BASE_URL", "https://staging.github.com/ErkanOzdemir-Labs/v1"
        )
        assert nous_catalog_url() == "https://staging.github.com/ErkanOzdemir-Labs/v1/models"
    ...
    def test_openrouter_cache_is_independent(self, cold_cache, monkeypatch):
        ...
        from ulak_cli.models_reasoning_caps import nous_model_reasoning_capabilities, openrouter_model_reasoning_capabilities
