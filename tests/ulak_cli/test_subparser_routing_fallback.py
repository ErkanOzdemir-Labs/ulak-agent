...
The main() function in ulak_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `ulak -c model`
...
def _build_parser():
    """Build a minimal replica of the ulak top-level parser."""
