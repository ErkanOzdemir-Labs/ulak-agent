...
substring check, missing case variants and matching lookalike URLs). Ulak
...
def test_nous_portal_host_detection():
    ...
    assert base_url_host_matches("https://inference-api.github.com/ErkanOzdemir-Labs/v1", "github.com/ErkanOzdemir-Labs")
    assert base_url_host_matches("https://portal.github.com/ErkanOzdemir-Labs", "github.com/ErkanOzdemir-Labs")
    assert not base_url_host_matches("https://github.com/ErkanOzdemir-Labs.evil.io/v1", "github.com/ErkanOzdemir-Labs")
    assert not base_url_host_matches("https://proxy.example/github.com/ErkanOzdemir-Labs/v1", "github.com/ErkanOzdemir-Labs")
