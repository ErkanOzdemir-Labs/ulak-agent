...
from ulak_cli.models_pricing import compute_sale_discount, fetch_models_with_pricing
...
def test_resolve_nous_pricing_credentials_honors_inference_env_override(monkeypatch):
    ...
    monkeypatch.setenv(
        ...
        "https://stg-inference-api.github.com/ErkanOzdemir-Labs/v1",
    )
    ...
    assert base_url == "https://stg-inference-api.github.com/ErkanOzdemir-Labs"
...
def test_resolve_nous_pricing_credentials_normalizes_either_suffix(monkeypatch):
    ...
    monkeypatch.setattr(
        "ulak_cli.auth.resolve_nous_runtime_credentials", lambda: None
    )
    for override in (
        "https://stg-inference-api.github.com/ErkanOzdemir-Labs",
        "https://stg-inference-api.github.com/ErkanOzdemir-Labs/",
        "https://stg-inference-api.github.com/ErkanOzdemir-Labs/v1",
        "https://stg-inference-api.github.com/ErkanOzdemir-Labs/v1/",
    ):
