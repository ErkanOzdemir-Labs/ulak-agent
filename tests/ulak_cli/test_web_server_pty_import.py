"""Test the platform-branched PTY bridge import in ulak_cli.web_server_chat.
...
def test_web_server_uses_posix_pty_bridge_on_posix():
    ...
    from ulak_cli.pty_bridge import PtyBridge as PosixBridge
    from ulak_cli.pty_bridge import PtyUnavailableError as PosixErr
...
def test_pty_bridge_import_block_is_platform_branched():
    ...
    from ulak_cli import web_server_chat
    ...
    #       try:
    #           from ulak_cli.win_pty_bridge import WinPtyBridge as PtyBridge, ...
    #       except ImportError:
    #           PtyBridge = None
    #           ...
    #   else:
    ...
    assert "from ulak_cli.win_pty_bridge import" in src
    assert "from ulak_cli.pty_bridge import" in src
