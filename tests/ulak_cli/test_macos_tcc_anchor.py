...
import ulak_cli.macos_tcc_anchor as tcc
...
class TestUvStoreDetection:
    ...
    def test_matches_ulak_runtime_repair_generation(self):
        path = (
            "/Users/u/ulak-agent/.ulak-runtime/python/"
...
class TestEnsureTccAnchor:
    ...
    def test_store_root_marker_tracks_managed_uv_constant(self):
        ...
        from ulak_cli.managed_uv import _RUNTIME_DIR_NAME
