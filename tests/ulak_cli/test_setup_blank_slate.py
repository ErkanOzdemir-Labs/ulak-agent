"""Tests for Blank Slate setup mode (ulak_cli/setup.py).
...
from ulak_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
