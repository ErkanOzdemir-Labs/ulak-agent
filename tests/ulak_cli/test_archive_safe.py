"""Tests for the shared tar.gz writer (``ulak_cli.archive_safe.make_targz``).

``make_targz`` backs both ``ulak profile export`` and ``ulak kanban
...
from ulak_cli.archive_safe import make_targz
