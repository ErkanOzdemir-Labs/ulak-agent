"""Tests for MCP tools interactive configuration in ulak_cli.tools_config."""

from unittest.mock import patch

from ulak_cli.tools_config import _configure_mcp_tools_interactive
...
_CHECKLIST = "ulak_cli.curses_ui.curses_checklist"
_SAVE = "ulak_cli.tools_config.save_config"
...
def test_disabling_tool_writes_include_list(capsys):
    ...
    catalog flow, `ulak mcp configure`, and this UI all write the same
