...
Q-B, exercises a real `ulak gateway run`); these lock the unit contract.
"""
...
class TestInstantiationEpoch:
    ...
    def test_marker_from_prior_instantiation_reads_as_absent(self, home, monkeypatch):
        ...
        # container/VM instantiation survives on the durable ULAK_HOME volume
