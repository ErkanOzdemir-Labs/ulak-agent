...
def store(tmp_path, monkeypatch):
    ...
    ~/.ulak/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at ulak_state import time, before pytest's ULAK_HOME monkeypatch
    fires — the autouse fixture's ULAK_HOME override doesn't help here.)
    """
    import ulak_state
