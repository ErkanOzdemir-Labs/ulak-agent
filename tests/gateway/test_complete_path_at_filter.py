...
def _reset_fuzzy_cache(monkeypatch):
    ...
    # via _load_cfg(), which resolves through _ulak_home captured at module
    # import time — before the per-test ULAK_HOME redirect applies. When the
