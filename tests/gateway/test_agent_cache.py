...
class TestAgentConfigSignature:
    ...
    def test_model_change_different_signature(self):
        ...
        runtime = {"api_key": "sk-test12345678", "base_url": "https://openrouter.ai/api/v1",
                    "provider": "openrouter"}
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["ulak-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("claude-opus-4.6", runtime, ["ulak-telegram"], "")
        assert sig1 != sig2
    ...
    def test_same_token_prefix_different_full_token_changes_signature(self):
        ...
        sig1 = GatewayRunner._agent_config_signature("gpt-5.3-codex", rt1, ["ulak-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("gpt-5.3-codex", rt2, ["ulak-telegram"], "")
        assert sig1 != sig2
    ...
    def test_provider_change_different_signature(self):
        ...
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", rt1, ["ulak-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("claude-sonnet-4", rt2, ["ulak-telegram"], "")
        assert sig1 != sig2
    ...
    def test_default_gateway_runtime_forwards_filtered_capabilities(self, monkeypatch):
        ...
        from ulak_cli import runtime_provider
...
class TestExtractCacheBustingConfig:
    ...
    def test_reads_compression_subkeys(self):
        ...
        assert out["compression.codex_app_server_auto"] == "ulak"
...
class TestAgentCacheLifecycle:
    ...
    def test_cache_hit_returns_same_agent(self):
        ...
        sig = runner._agent_config_signature("anthropic/claude-sonnet-4", runtime, ["ulak-telegram"], "")
...
class TestAgentConfigSignatureUserId:
    ...
    def test_signature_omits_user_id_when_absent(self):
        ...
        sig_implicit = GatewayRunner._agent_config_signature(
            "claude-sonnet-4", runtime, ["ulak-telegram"], "",
        )
...
class TestAgentCacheMessageCountRebaseline:
    ...
    def _runner_with_db(self, db):
        from ulak_state import AsyncSessionDB
