"""Tests for _setup_feishu() in ulak_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("ulak_cli.config.save_env_value", side_effect=mock_save), \
         patch("ulak_cli.config.get_env_value", side_effect=mock_get), \
         patch("ulak_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("ulak_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("ulak_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("ulak_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("ulak_cli.cli_output.print_header"), \
         patch("ulak_cli.cli_output.print_info"), \
         patch("ulak_cli.cli_output.print_success"), \
         patch("ulak_cli.cli_output.print_warning"), \
         patch("ulak_cli.cli_output.print_error"), \
