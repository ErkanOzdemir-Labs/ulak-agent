"""Regression test: ulak update must not load cryptography eagerly."""
...
assert 'ulak_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running ulak update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so ulak_cli is importable,
