...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and ulak-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # ulak-agent (tests/skills/)
]
