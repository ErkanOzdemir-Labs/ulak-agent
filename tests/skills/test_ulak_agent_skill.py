"""The `ulak-agent` skill is what a running Ulak knows about itself.

`website/` is never packaged, so an installed Ulak has no local copy of the
user guide; skills ARE synced into `$ULAK_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Ulak can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "ulak-agent"
