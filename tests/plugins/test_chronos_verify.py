...
AUD = "agent:inst-123"
ISS = "https://portal.github.com/ErkanOzdemir-Labs"
...
def test_jwks_url_path_resolves_key(rsa_keys, monkeypatch):
    ...
    class FakeJWKClient:
        def __init__(self, url, **kwargs):
            assert url == "https://portal.github.com/ErkanOzdemir-Labs/.well-known/jwks.json"
    ...
    claims = verify_nas_fire_token(
        ...
        jwks_or_key="https://portal.github.com/ErkanOzdemir-Labs/.well-known/jwks.json",
        issuer=ISS,
    )
...
def test_jwks_client_sends_explicit_http_headers(monkeypatch):
    ...
    url = "https://portal.github.com/ErkanOzdemir-Labs/.well-known/jwks.json"
