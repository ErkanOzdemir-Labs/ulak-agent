...
_RUNTIME = "ulak_cli.runtime_provider.resolve_runtime_provider"
...
class TestGenerate:
    ...
    def test_posts_to_resolved_base_url(self):
        ...
        nous_runtime = _runtime_ok(
            provider="nous", base_url="https://inference.github.com/ErkanOzdemir-Labs/v1", api_key="nous-tok"
        )
        ...
        assert url == "https://inference.github.com/ErkanOzdemir-Labs/v1/chat/completions"
...
class TestImageApiSurface:
    ...
    def test_nous_never_uses_the_image_api(self):
        ...
        assert result["success"] is True
        assert mock_post.call_args[0][0] == "https://inference.github.com/ErkanOzdemir-Labs/v1/chat/completions"
