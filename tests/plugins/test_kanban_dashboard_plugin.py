...
def _load_plugin_router():
    ...
    spec = importlib.util.spec_from_file_location(
        "ulak_dashboard_plugin_kanban_test", plugin_file,
    )
...
def test_ws_events_rejects_when_token_required(tmp_path, monkeypatch):
    ...
    monkeypatch.setitem(sys.modules, "ulak_cli.web_server_chat", stub)
    monkeypatch.setattr(ulak_cli, "web_server_chat", stub, raising=False)
...
# tests/ulak_cli/test_kanban_db.py. The OUTER fallback here is not, which
