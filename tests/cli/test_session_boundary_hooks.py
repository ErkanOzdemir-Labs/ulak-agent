...
from ulak_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/ulak_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("ulak_cli.lifecycle.invoke_hook")
@patch("ulak_cli.lifecycle.finalize_session")
