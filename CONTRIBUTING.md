...
If your skill is specialized, community-contributed, or niche, it's better suited for a **Skills Hub** — upload it to a skills registry and share it in the [Ulak Agent Discord](https://discord.gg/ErkanOzdemir-Labs). Users can install it with `ulak skills install`.
...
- Promote it in the [Ulak Agent Discord](https://discord.gg/ErkanOzdemir-Labs) `#plugins-skills-and-skins` channel so users can find and install it
