...
logger = logging.getLogger("ulak_state")  # caplog tests pin the origin module's name
...
def _stale_holder(row, now: float) -> bool:
    ...
    from ulak_state import _compression_lock_holder_process_is_dead
...
class SessionMessagesMixin:
    ...
    def _check_transcript_write_guards(self, conn, session_id: str, compression_lock_holder: Optional[str],
        ...
        from ulak_state_errors import CompressionSessionClosedError, SessionTurnLeaseLostError
    ...
    def replace_messages(self, session_id: str, messages: List[Dict[str, Any]], active_only: bool = False,
        ...
        """
        from ulak_state_errors import CompressionSessionClosedError
        def _do(conn):
    ...
    def _rows_to_conversation(self, rows, *, session_id: str, include_ancestors: bool, repair_alternation: bool,
        ...
        from ulak_state import _strip_background_review_harness, _strip_stale_tool_call_markers
        messages = []
    ...
    def purge_stale_tool_call_markers(self, *, dry_run: bool = False, backup: bool = True) -> Dict[str, Any]:
        ...
        from ulak_state import _STALE_TOOL_CALL_MARKER_RE
