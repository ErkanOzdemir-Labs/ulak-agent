...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Ulak session"),
        ...
        _cmd("status", "Show Ulak session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Ulak agent"),
        ...
        _cmd("update", "Update Ulak Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Ulak gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Ulak session in it",
