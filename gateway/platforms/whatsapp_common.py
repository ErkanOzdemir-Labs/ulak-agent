...
class WhatsAppBehaviorMixin:
    ...
    DEFAULT_REPLY_PREFIX: str = "⚕ *Ulak Agent*\n────────────\n"
...
def resolve_whatsapp_bridge_dir() -> Path:
    ...
    try:
        ...
        pass
    if ulak_home_bridge.exists():
        return ulak_home_bridge
    try:
        ulak_home_bridge.parent.mkdir(parents=True, exist_ok=True)
        shutil.copytree(install_bridge, ulak_home_bridge, dirs_exist_ok=False)
        return ulak_home_bridge
    except Exception:
        return install_bridge
