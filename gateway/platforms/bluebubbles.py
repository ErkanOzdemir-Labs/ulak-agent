...
# `require_mention: true` without custom aliases uses Ulak wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?ulak\s+agent\b[,:\-]?", r"(?<![\w@])@?ulak\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Ulak defaults)."""
