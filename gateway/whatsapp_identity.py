...
plugins should use :func:`canonical_whatsapp_identifier` to line up with Ulak' session keys.
"""
...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    if not normalized:
        return set()
    session_dir = get_ulak_dir("platforms/whatsapp/session", "whatsapp/session")
