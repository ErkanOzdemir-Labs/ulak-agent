...
await build({
  ...
  // Skip the prebuilt @ulak/ink bundle and inline the source instead:
  ...
  alias: { '@ulak/ink': resolve(root, 'packages/ulak-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The ulak_cli launcher
