 ...
 * across theme x background scenes to <tmpdir>/ulak-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@ulak/ink'
...
// The regenerated slate light_colors block from ulak_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/ulak-agent',
...
const setup = (bgHex: string) => {
  process.env.ULAK_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
