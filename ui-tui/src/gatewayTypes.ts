import type { BillingBlock, UsageModelData } from '@ulak/shared/billing'
import type { UlakSkin } from '@ulak/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@ulak/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = UlakSkin
...
// Wire shapes now live in @ulak/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
