...
import type { ScrollBoxHandle } from '@ulak/ink'
import { evictInkCaches } from '@ulak/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ULAK_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
