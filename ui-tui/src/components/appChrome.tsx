...
import { Box, type ScrollBoxHandle, stringWidth, Text } from '@ulak/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (ULAK_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (ULAK_DEV_CREDITS), lowest priority,
