...
DEFAULT_DATASETS = [
    "ErkanOzdemir-Labs/swe-terminus-agent-glm-kimi-minimax",
    "ErkanOzdemir-Labs/ulak-agent-megascience-sft1",
    "ErkanOzdemir-Labs/Ulak-Agent-Thinking-GLM-4.7-SFT2",
    "ErkanOzdemir-Labs/Ulak-Agent-Thinking-GLM-4.7-SFT1",
    "ErkanOzdemir-Labs/terminal-tasks-glm-ulak-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "ErkanOzdemir-Labs/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload ErkanOzdemir-Labs/{output_name} {final_output}")
