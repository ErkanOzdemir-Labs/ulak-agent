#!/usr/bin/env python3
"""Build the Ulak Model Catalog — a centralized JSON manifest of curated models.
...
Ulak CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Ulak release.
...
# Ensure ULAK_HOME is set for imports that touch it at module level.
os.environ.setdefault("ULAK_HOME", os.path.join(os.path.expanduser("~"), ".ulak"))

from ulak_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "ulak-agent repo",
            "docs": "https://ulak-agent.github.com/ErkanOzdemir-Labs/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Ulak '
