#!/usr/bin/env python3
"""Build the Ulak Skills Index — a centralized JSON catalog of all skills.
...
`ulak skills search/install` can use it without hitting the GitHub API.
...
# Ensure ULAK_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building Ulak Skills Index...", flush=True)
