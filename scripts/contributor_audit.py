...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Ulak\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (ulak-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "noreply@github.com",
    "noreply@github.com/ErkanOzdemir-Labs",
    "cursoragent@cursor.com",
    "ulak@github.com/ErkanOzdemir-Labs",
    "ulak-audit@example.com",
    "nousbot@github.com/ErkanOzdemir-Labs",
    "ulak@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "ErkanOzdemir-Labs/ulak-agent",
                "--state", "merged",
