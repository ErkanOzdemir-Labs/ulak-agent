#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Ulak logs.
...
With no LOGFILE, reads ``$ULAK_HOME/logs/agent.log`` (default ~/.ulak).
...
def default_log() -> Path:
    home = os.environ.get("ULAK_HOME") or str(Path.home() / ".ulak")
