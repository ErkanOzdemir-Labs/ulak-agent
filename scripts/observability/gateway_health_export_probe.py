...
def main() -> None:
    ...
    ulak_home = Path(tempfile.mkdtemp(prefix="ulak-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "ulak-gateway-smoke",
    ...
    print(json.dumps({"ulak_home": str(ulak_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
