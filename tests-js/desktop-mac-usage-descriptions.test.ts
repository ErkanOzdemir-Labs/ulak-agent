 ...
 *
 * Each entry is a key/value pair that lands in the packaged Ulak.app's
 ...
 * "Ulak wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Ulak wants to access Music" when Ulak never touches the Music
