 ...
 *
 * Ulak Desktop signs with ``hardenedRuntime: true`` and points
...
test('bootstrap installer carries microphone entitlement for launcher attribution', () => {
  ...
  assert.equal(
    ...
    'the macOS bootstrap installer must sign with its entitlements.plist. ' +
      'When /Applications/Ulak.app is the setup launcher, macOS TCC treats ' +
      'com.erkanozdemir-labs.ulak.setup as the responsible process for the desktop ' +
