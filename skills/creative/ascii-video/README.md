...
Built for [Ulak Agent](https://github.com/ErkanOzdemir-Labs/ulak-agent). Usable in any coding agent. Canonical source lives here; synced to [`ErkanOzdemir-Labs/ulak-agent/skills/creative/ascii-video`](https://github.com/ErkanOzdemir-Labs/ulak-agent/tree/main/skills/creative/ascii-video) via PR.
