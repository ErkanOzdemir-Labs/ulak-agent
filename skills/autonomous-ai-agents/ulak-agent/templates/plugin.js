/**
 * Ulak desktop plugin template. Save as:
 *   <ulak home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <ulak home> is ~/.ulak by default, or ~/.ulak/profiles/<name>
 * when running a named profile (`ulak -p <name>`). Run `ulak doctor` (or
 ...
 * Only these imports resolve: @ulak/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@ulak/plugin-sdk'
