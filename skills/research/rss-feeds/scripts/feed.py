...
Standard library only, so it runs in any Ulak environment without an install
...
USER_AGENT = "ulak-agent/1.0 (rss-feeds skill; +https://github.com/ErkanOzdemir-Labs/ulak-agent)"
TIMEOUT = 20
NS = {
