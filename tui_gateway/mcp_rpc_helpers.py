...
def summarize_server(name: str, cfg: dict) -> Dict[str, Any]:
    ...
    """
    from ulak_cli.mcp_config import _oauth_tokens_present
...
def resolve_profile(rid, params, err_fn) -> Tuple[Optional[Any], Optional[dict]]:
    """Resolve the optional ``profile`` param to a ULAK_HOME override token.
    ...
    return set_ulak_home_override(str(profile_dir)), None
# ---- END PLUGIN-COMPAT ----
