...
from ulak_constants import OPENROUTER_BASE_URL, get_ulak_home
from agent.retry_utils import jittered_backoff
from ulak_cli.env_loader import load_ulak_dotenv

# Load .env from ULAK_HOME first, then project root as a dev fallback.
load_ulak_dotenv(ulak_home=get_ulak_home(), project_env=Path(__file__).parent / ".env")
...
_PROVIDER_HOSTS: Tuple[Tuple[str, str], ...] = (
    ("openrouter.ai", "openrouter"), ("github.com/ErkanOzdemir-Labs", "nous"), ("z.ai", "zai"), ("moonshot.ai", "kimi-coding"),
...
class TrajectoryCompressor:
    ...
    def _init_summarizer(self):
        ...
        if provider:
            ...
            if client is None:
                raise RuntimeError(f"Provider '{provider}' is not configured. Check your API key or run: ulak setup")
