...
benchmarked ten harnesses on hostile-file handling — and whose Ulak column
...
Every task runs the full Ulak agent (file + terminal + search toolsets)
...
Rules of engagement (from ulakbench discipline):
