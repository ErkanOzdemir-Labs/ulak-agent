...
os.environ.setdefault("ULAK_HOME", os.path.expanduser("~/.ulak"))  # LIVE: real auxiliary judge calls (cents)
from ulak_cli import goals
goal = ("Simplify the ulak-agent codebase by >=30% LOC with zero behavior change, decomposing every god file, "
