...
os.environ["ULAK_HOME"] = tempfile.mkdtemp(prefix="hh-")
os.environ["ULAK_STREAM_RETRIES"] = "0"
...
class H(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if auth == f"Bearer {FRESH}":
            ...
            body = json.dumps({"error": {"type": "authentication_error", "message": "Your API key is invalid, blocked or out of funds. Please go visit the portal to sort that out: https://portal.github.com/ErkanOzdemir-Labs "}}).encode()
...
import ulak_cli.nous_auth_keepalive as ka
