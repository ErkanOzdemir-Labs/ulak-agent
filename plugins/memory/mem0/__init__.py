...
self-hosted Mem0 server (MEM0_HOST, HTTP), or OSS Memory. Secrets live in $ULAK_HOME/.env
(MEM0_API_KEY, MEM0_HOST); settings in $ULAK_HOME/mem0.json via `ulak memory setup`:
...
def _load_config() -> dict:
    """Env vars provide defaults; $ULAK_HOME/mem0.json overrides individual keys.
    ...
    config = {"mode": os.environ.get("MEM0_MODE", "platform"), "api_key": get_secret("MEM0_API_KEY", ""), "host": os.environ.get("MEM0_HOST", ""), "agent_id": os.environ.get("MEM0_AGENT_ID", "ulak"), "oss": {}}
    ...
    file_cfg = _read_mem0_json(get_ulak_home() / "mem0.json")
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        self._mode, self._api_key, self._host, self._user_id, self._agent_id = "platform", "", "", _DEFAULT_USER_ID, "ulak"
    ...
    def save_config(self, values, ulak_home):
        """Merge-write config to $ULAK_HOME/mem0.json."""
        from utils import atomic_json_write
        config_path = Path(ulak_home) / "mem0.json"
    ...
    def get_config_schema(self):
        ...
        return [
            ...
            {"key": "user_id", "description": "User identifier", "default": "ulak-user"},
            {"key": "agent_id", "description": "Agent identifier", "default": "ulak"},
            {"key": "rerank", "description": "Enable reranking for recall", "default": "false", "choices": ["true", "false"]},
        ]

    def post_setup(self, ulak_home: str, config: dict) -> None:
        from ._setup import post_setup
        post_setup(ulak_home, config)
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._mode, self._api_key, self._host, self._agent_id = cfg.get("mode", "platform"), cfg.get("api_key", ""), cfg.get("host", ""), cfg.get("agent_id", "ulak")
