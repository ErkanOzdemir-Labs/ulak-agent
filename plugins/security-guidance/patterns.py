...
ErkanOzdemir-Labs modifications: pattern data unchanged from upstream; the upstream RuleId
telemetry table (Claude Code PostToolUse metrics) is dropped — Ulak has no consumer.
Ulak-side wiring lives in __init__.py.
"""
