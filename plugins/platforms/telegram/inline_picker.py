...
The BotCommand menu is capped (100/scope, Ulak uses 60), so inline mode (``@yourbot <query>``, 50 per
...
def collect_inline_catalog() -> List[Dict[str, str]]:
    ...
    try:
        from ulak_cli.commands_platforms import _collect_gateway_skill_entries, _sanitize_telegram_name, telegram_bot_commands
