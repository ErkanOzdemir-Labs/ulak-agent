...
class SmsAdapter(BasePlatformAdapter):
    """Twilio SMS <-> Ulak: one session per inbound number; replies always from TWILIO_PHONE_NUMBER."""
...
# ulak_cli/gateway.py, and the _send_sms dispatch in tools/send_message_tool.py. TWILIO_*
