...
via :func:`ulak_cli.runtime_provider.resolve_runtime_provider`. OpenRouter alone also
...
_ATTRIBUTION_HEADERS = {
    ...
    "HTTP-Referer": "https://github.com/ErkanOzdemir-Labs/ulak-agent",
    "X-Title": "Ulak Agent",
}
        ...
        **kwargs: Any,
        ...
        if not api_key or not base_url:
            return fail(
                ...
                f"Configure {self._display} in `ulak tools` → Image Generation.",
                "missing_api_key")
