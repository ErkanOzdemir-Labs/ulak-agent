 ...
 *
 * Values mirror ulak_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Ulak default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Ulak' default when unset). */
