 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `ulak_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Ulak Teal",
  description: "Classic dark teal — the canonical Ulak look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Ulak Teal (Large)",
  description: "Ulak Teal with bigger fonts and roomier spacing",
