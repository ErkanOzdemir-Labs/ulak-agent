...
const STORAGE_KEY = "ulak-dashboard-theme";
...
const FONT_STORAGE_KEY = "ulak-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `ulak_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "ulak-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-ulak-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-ulak-theme-font", "true");
