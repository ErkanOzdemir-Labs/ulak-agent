...
export const en: Translations = {
  ...
  status: {
    ...
    updateUlakConfirmMessage:
      "This runs ulak update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateUlakConfirmNow: "Update now",
    updateUlakConfirmTitle: "Update Ulak?",
    updatingUlak: "Updating Ulak…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Ulak plugins (`ulak plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.ulak/plugins/?",
    removeHint: "Only user-installed plugins under ~/.ulak/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.ulak/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Ulak doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Ulak Achievements",
      subtitle:
        "Collectible Ulak badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Ulak session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Ulak more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Ulak sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Ulak is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Ulak Agent ☤",
    },
  },
