 ...
 *
 * Plugins call window.__ULAK_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__ULAK_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__ULAK_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__ULAK_PLUGIN_SDK__ = {
    ...
    // window.__ULAK_SESSION_TOKEN__ directly.
    authedFetch,
