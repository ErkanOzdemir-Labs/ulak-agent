 ...
 * `window.__ULAK_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Ulak brand in the top bar
 ...
 *  `window.__ULAK_PLUGINS__.registerSlot(...)`.
 *
