/**
 * Ulak Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__ULAK_PLUGIN_SDK__`` and
 * ``window.__ULAK_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__ULAK_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``UlakPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@ulak/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__ULAK_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__ULAK_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__ULAK_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface UlakPluginSDK {
...
declare global {
  interface Window {
    __ULAK_PLUGIN_SDK__?: UlakPluginSDK;
    __ULAK_PLUGINS__?: PluginRegistry;
  }
}
